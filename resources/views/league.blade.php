<div>
    <div class="m-4">
        <form action="{{ route('league-show') }}" method="post">
@csrf
            <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input name="phone" type="text" class="form-control" id="inputEmail" placeholder="Phone" required>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Select League</label>
                    <div class="col-sm-10">
                ...
                <div class="league-show">
                    @foreach ($leagues as $league )
                        <li><a href="{{ route('league-edit', ['id'=>$league->id]) }}">{{ $league->name }}</a></li>
